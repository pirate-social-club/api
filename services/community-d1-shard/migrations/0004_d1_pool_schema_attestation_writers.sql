-- Allow generation-fenced local writers to keep newly provisioned and migrated
-- shards attested between authoritative full-fleet scans. The release reader
-- remains shadow-only; this changes storage vocabulary, not release authority.
