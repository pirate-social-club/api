  ...
  test("reports sum and critical-path maximum for probe-visible hydration phases", () => {
    const result = summarizeHomeFeedCommunityPhaseTimings([
      communityTiming({
        ...
        batched_reads_ms: 30,
        localize_ms: 12,
        author_handles_ms: 14,
        streaks_ms: 8,
        derivatives_ms: 6,
        derivative_local_rows_ms: 1,
        derivative_global_rows_ms: 2,
        derivative_profiles_ms: 3,
        unaccounted_ms: 24,
      }),
      communityTiming({
        total_ms: 160,
        ...
        batched_reads_ms: 25,
        localize_ms: 18,
        author_handles_ms: 21,
        streaks_ms: 11,
        derivatives_ms: 9,
        derivative_local_rows_ms: 2,
        derivative_global_rows_ms: 3,
        derivative_profiles_ms: 4,
        unaccounted_ms: 47,
      }),
    ])
    ...
    expect(result).toEqual({
      ...
      community_author_handles_sum_ms: 35,
      community_author_handles_max_ms: 21,
      community_streaks_sum_ms: 19,
      community_streaks_max_ms: 11,
      community_derivatives_sum_ms: 15,
      community_derivatives_max_ms: 9,
      community_derivative_local_rows_sum_ms: 3,
      community_derivative_local_rows_max_ms: 2,
      community_derivative_global_rows_sum_ms: 5,
      community_derivative_global_rows_max_ms: 3,
      community_derivative_profiles_sum_ms: 7,
      community_derivative_profiles_max_ms: 4,
