...
export function serializeAsset(row: AssetRow, input?: { redactPrimaryForLocked?: boolean }): Asset {
  ...
  return {
    ...
    story_ip_metadata_uri: row.story_ip_metadata_uri,
    story_ip_metadata_hash: row.story_ip_metadata_hash,
    story_nft_metadata_uri: row.story_nft_metadata_uri,
    story_nft_metadata_hash: row.story_nft_metadata_hash,
