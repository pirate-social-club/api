...
async function reservePurchaseSettlementAttempt(input: {
  client: SettlementExecutor
  communityId: string
  quoteId: string
  purchaseId: string
...
async function listStalePurchaseSettlementAttempts(input: {
  client: SettlementExecutor
  staleBefore: string
  limit: number
...
async function markPurchaseSettlementAttemptFailed(input: {
  client: SettlementExecutor
  quoteId: string
