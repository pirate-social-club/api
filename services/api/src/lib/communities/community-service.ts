...
function serializeCommunity(row: CommunityRow, local: LocalCommunitySnapshot | null): Community {
  ...
  return {
    ...
    civility_policy: { community_id: row.community_id, policy_origin: "default", group_directed_demeaning_language: "review", targeted_insults: "review", targeted_harassment: "disallow", threatening_language: "disallow", updated_at: policyUpdatedAt },
