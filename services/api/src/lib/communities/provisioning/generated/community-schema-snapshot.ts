...
// 129 core/db/community-template migrations into an in-memory DB and
...
export const COMMUNITY_SCHEMA_STATEMENTS: readonly string[] = [
  ...
  "CREATE TABLE community_jobs (\n    job_id TEXT PRIMARY KEY,\n    community_id TEXT NOT NULL,\n    job_type TEXT NOT NULL,\n    subject_type TEXT NOT NULL,\n    subject_id TEXT NOT NULL,\n    status TEXT NOT NULL CHECK (\n        status IN ('queued', 'running', 'succeeded', 'failed')\n    ),\n    payload_json TEXT,\n    result_ref TEXT,\n    error_code TEXT,\n    attempt_count INTEGER NOT NULL DEFAULT 0,\n    available_at TEXT,\n    created_at TEXT NOT NULL,\n    updated_at TEXT NOT NULL, last_checkpoint TEXT, last_checkpoint_at TEXT, attempt_started_at TEXT, attempt_deadline_at TEXT,\n    FOREIGN KEY (community_id) REFERENCES communities(community_id)\n);",
