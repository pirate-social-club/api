...
describe("d1NativeProvisioningBackend", () => {
  ...
  test("§8.1 — provision() calls communityD1Bind, then communityD1LoadSnapshot, then upsertD1CommunityRoutingRow('ready')", async () => {
    ...
    // Call sequence: bind → load → upsertRouting('ready').
