import type { KalshiEmbedTarget, PolymarketEmbedTarget } from "./embed-url-detection"
...
type PredictionMarketTarget = KalshiEmbedTarget | PolymarketEmbedTarget
...
async function storeUnavailablePredictionMarketEmbed(
  input: ProviderEmbedHydrationInput<PredictionMarketTarget>,
): Promise<string> {
...
export async function hydrateKalshiMarketEmbed(
  input: ProviderEmbedHydrationInput<KalshiEmbedTarget>,
): Promise<string | null> {
  ...
  if (!market || typeof market !== "object") {
    return storeUnavailablePredictionMarketEmbed(input)
  }
...
export async function hydratePolymarketEventEmbed(
  input: ProviderEmbedHydrationInput<PolymarketEmbedTarget>,
): Promise<string | null> {
...
export async function hydratePolymarketMarketEmbed(
  input: ProviderEmbedHydrationInput<PolymarketEmbedTarget>,
): Promise<string | null> {
