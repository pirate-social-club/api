...
const COPY: Record<StudyHelperLanguage, StudyCopy> = {
  en: {
    ...
    exerciseExpired: "This study exercise expired. Send /study to start again.", extra: "Extra", lineWas: "The line was", labelSeparator: ":", missing: "Missing",
    ...
    studyUnavailable: "Study is not available here yet.", translationsReady: "Translations are ready.", youSaid: "You said",
  },
  zh: {
    ...
    exerciseExpired: "此学习练习已过期。请发送 /study 重新开始。", extra: "多说", lineWas: "原句是", labelSeparator: "：", missing: "漏说",
    ...
    studyUnavailable: "此处暂未开放学习功能。", translationsReady: "翻译已准备好。", youSaid: "你说的是",
  },
  ar: {
    ...
    exerciseExpired: "انتهت صلاحية هذا التمرين. أرسل /study للبدء مجددًا.", extra: "إضافي", lineWas: "كان السطر", labelSeparator: ":", missing: "ناقص",
    ...
    studyUnavailable: "الدراسة غير متاحة هنا بعد.", translationsReady: "الترجمات جاهزة.", youSaid: "قلت",
  },
  ka: {
    ...
    exerciseExpired: "ამ სავარჯიშოს ვადა გაუვიდა. თავიდან დასაწყებად გაგზავნეთ /study.", extra: "ზედმეტი", lineWas: "სტრიქონი იყო", labelSeparator: ":", missing: "აკლია",
    ...
    studyUnavailable: "სწავლა აქ ჯერ ხელმისაწვდომი არ არის.", translationsReady: "თარგმანები მზადაა.", youSaid: "თქვენ თქვით",
  },
}
