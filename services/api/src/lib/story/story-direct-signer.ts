...
export function resolveStorySettlementDirectSigner(
  env: Pick<Env, "STORY_RUNTIME_PRIVATE_KEY" | "STORY_CONTRACT_OWNER_PRIVATE_KEY" | "MUSIC_PURCHASE_STORY_SETTLEMENT_PRIVATE_KEY" | "MUSIC_PURCHASE_STORY_SETTLEMENT_PKP_ADDRESS">,
): ConfigResult<StoryDirectSignerConfig | null> {
  return resolveStoryDirectSignerConfig({
    privateKeyValue: env.MUSIC_PURCHASE_STORY_SETTLEMENT_PRIVATE_KEY ?? env.STORY_RUNTIME_PRIVATE_KEY ?? env.STORY_CONTRACT_OWNER_PRIVATE_KEY,
