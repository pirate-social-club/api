...
export type Env = {
  ...
  PIRATE_CHECKOUT_CUSTODY_KEY_EPOCH?: string
  COMMUNITY_HANDLE_CLAIM_INTENTS_ENABLED?: string
  COMMUNITY_HANDLE_CLAIM_REFUNDS_ENABLED?: string
  COMMUNITY_HANDLE_CLAIM_PAYMENT_CLOCK_SKEW_SECONDS?: string
  COMMUNITY_HANDLE_CLAIM_FUNDED_RESERVATION_SECONDS?: string
  COMMUNITY_HANDLE_CLAIM_AUTHORIZATION_RELEASE_GRACE_SECONDS?: string
  ...
  STORY_ENTITLEMENT_CLASS_CONFIGURER_CONTRACT?: string
  STORY_MARKETPLACE_SETTLEMENT_CONTRACT?: string
  STORY_PIRATE_SIGNER_REGISTRY_CONTRACT?: string
  STORY_PURCHASE_ENTITLEMENT_TOKEN_CONTRACT?: string
  ...
  STORY_CONTRACT_OWNER_MIN_BALANCE_WEI?: string
  STORY_ENTITLEMENT_CLASS_CONFIGURER_PRIVATE_KEY?: string
  STORY_RUNTIME_FUNDER_PRIVATE_KEY?: string
  STORY_RUNTIME_FUNDER_MIN_BALANCE_WEI?: string
  BASE_RUNTIME_OPERATOR_MIN_BALANCE_WEI?: string
  BASE_RUNTIME_OPERATOR_MIN_USDC_ATOMIC?: string
  RUNTIME_WALLET_FUNDING_WATCHDOG_INTERVAL_MS?: string
  ...
  SONG_STUDY_FILL_BLANK_RESERVED_SLOTS?: string
  ...
  OPENROUTER_LANGUAGE_DETECTION_MODEL?: string
  OPENROUTER_LANGUAGE_DETECTION_MIN_CONFIDENCE?: string
  OPENROUTER_LANGUAGE_DETECTION_MIN_WORDS?: string
  OPENROUTER_LANGUAGE_DETECTION_MIN_CHARS?: string
  OPENROUTER_LANGUAGE_DETECTION_TIMEOUT_MS?: string
  OPENROUTER_LANGUAGE_DETECTION_MAX_COMPLETION_TOKENS?: string
  ...
  HNS_NAMESPACE_REVALIDATION_ENABLED?: string
