export type Env = {
  ...
  ALTCHA_POW_COST_COMMUNITY_JOIN?: string
  ALTCHA_POW_COST_POST_CREATE?: string
  ALTCHA_POW_COST_COMMENT_CREATE?: string
  ALTCHA_POW_COST_POST_VOTE?: string
  ALTCHA_POW_COST_COMMENT_VOTE?: string
  ALTCHA_POW_COUNTER_MIN?: string
  ALTCHA_POW_COUNTER_MIN_COMMUNITY_JOIN?: string
  ALTCHA_POW_COUNTER_MIN_POST_CREATE?: string
  ALTCHA_POW_COUNTER_MIN_COMMENT_CREATE?: string
  ALTCHA_POW_COUNTER_MIN_POST_VOTE?: string
  ALTCHA_POW_COUNTER_MIN_COMMENT_VOTE?: string
  ALTCHA_POW_COUNTER_MAX?: string
  ALTCHA_POW_COUNTER_MAX_COMMUNITY_JOIN?: string
  ALTCHA_POW_COUNTER_MAX_POST_CREATE?: string
  ALTCHA_POW_COUNTER_MAX_COMMENT_CREATE?: string
  ALTCHA_POW_COUNTER_MAX_POST_VOTE?: string
  ALTCHA_POW_COUNTER_MAX_COMMENT_VOTE?: string
  ALTCHA_CHALLENGE_TTL_SECONDS?: string
  ALTCHA_CHALLENGE_RATE_LIMIT?: string
  ALTCHA_CHALLENGE_RATE_LIMIT_WINDOW_SECONDS?: string
  COMMUNITY_GATE_POLICY_CACHE_TTL_MS?: string
