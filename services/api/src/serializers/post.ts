...
export function serializePost(post: Post): CurrentPostResponse {
  return {
    ...
    author_user: post.identity_mode === "public" && post.author_user_id ? publicId(post.author_user_id, "usr") : null,
    author_public_handle: post.identity_mode === "public" ? post.author_public_handle ?? null : null,
    authorship_mode: post.authorship_mode,
    agent: post.agent_id ? publicId(post.agent_id, "agt") : post.agent_id,
    ...
    comments_locked_by_user: post.comments_locked_by_user_id ? publicId(post.comments_locked_by_user_id, "usr") : null,
    ...
    crosspost_source: post.crosspost_source
      ? {
          ...
          author_user: post.crosspost_source.author_user_id ? publicId(post.crosspost_source.author_user_id, "usr") : null,
